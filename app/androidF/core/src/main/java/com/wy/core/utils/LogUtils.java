...
import com.wy.core.BuildConfig;
...
public class LogUtils {
    private static Boolean LOG_SWITCH = BuildConfig.LOG_ENABLE; // 日志文件总开关
    private static Boolean LOG_TO_FILE = LOG_SWITCH; // 日志写入文件开关
    private static String LOG_TAG = "info"; // 默认的tag
    private static char LOG_TYPE = 'e';// 输入日志类型，v代表输出所有信息,w则只输出警告...
     ...
     * @param level
     */
    private static void log(String tag, Object msgo, Throwable tr, char level) {
        if (LOG_SWITCH) {
