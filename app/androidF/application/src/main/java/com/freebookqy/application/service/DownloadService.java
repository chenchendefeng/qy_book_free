package com.freebookqy.application.service;
...
import com.freebookqy.application.app.base.BaseService;
import com.freebookqy.application.app.rx.RxBus;
import com.freebookqy.application.app.utils.NetworkUtils;
import com.freebookqy.application.mvp.model.dao.BookChapterBean;
import com.freebookqy.application.mvp.model.dao.DownloadTaskBean;
import com.freebookqy.application.mvp.model.event.DeleteResponseEvent;
import com.freebookqy.application.mvp.model.event.DeleteTaskEvent;
import com.freebookqy.application.mvp.model.event.DownloadMessage;
import greendao.BookRepository;
import greendao.LocalRepository;
    ...
    private void executeTask(DownloadTaskBean taskEvent) {
        Runnable runnable = () -> {
            ...
            if (result == LOAD_NORMAL) {
                ...
                taskEvent.setSize(BookRepository.getBookSize(taskEvent.getBookId()));//Task的大小
                //发送完成状态
