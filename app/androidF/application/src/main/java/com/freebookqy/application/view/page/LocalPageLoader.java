...
import com.freebookqy.utilslib.MD5Utils;
...
public class LocalPageLoader extends PageLoader {
    ...
    //编码类型
    private FileUtils.Charset mCharset;
    ...
    private List<TxtChapter> convertTxtChapter(List<BookChapterBean> bookChapters) {
        ...
        for (BookChapterBean bean : bookChapters) {
            ...
            chapter.setCid(Integer.valueOf(bean.getId()));
                ...
                while (strLength > 0) {
                    ...
                    if (strLength > MAX_LENGTH_WITH_NO_CHAPTER) {
                        ...
                        for (int i = chapterOffset + MAX_LENGTH_WITH_NO_CHAPTER; i < length; ++i) {
                            if (buffer[i] == FileUtils.Charset.BLANK) {
                                end = i;
                                break;
                            }
                        }
    ...
    public void saveRecord() {
        ...
        if (mCollBook != null && isChapterListPrepare) {
            ...
            mCollBook.setLastRead(StringUtils.
                    dateConvert(System.currentTimeMillis(), Constant.getFORMAT_BOOK_DATE()));
            //直接更新
    ...
    public void refreshChapterList() {
        ...
        //获取文件编码
        mCharset = FileUtils.getCharsetObj(mBookFile.getAbsolutePath());

        String lastModified = StringUtils.dateConvert(mBookFile.lastModified(), Constant.getFORMAT_BOOK_DATE());
