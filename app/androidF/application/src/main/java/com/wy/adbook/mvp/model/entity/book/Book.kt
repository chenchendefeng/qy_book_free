...
class Book : Serializable {
    ...
    fun createCollBookBean(): CollBookBean {
        ...
        bean.bookCovers = bookCovers
        bean.readedCount = readedCount
        bean.readingCount = readingCount
        bean.collectionCount = collectionCount
        bean.shelfStatus = shelfStatus
        bean.source = source
        //bean.setHasCp()
