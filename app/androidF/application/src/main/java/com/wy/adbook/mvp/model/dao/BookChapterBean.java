...
public class BookChapterBean implements Serializable {
    ...
    @Generated(hash = 1141014811)
    public BookChapterBean(boolean isSelected, String id, int bid, String link, String title,
            String taskName, boolean unreadble, String bookId, long start, long end) {
