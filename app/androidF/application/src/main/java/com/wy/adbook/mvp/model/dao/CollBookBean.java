...
public class CollBookBean implements Parcelable {
    ...
    private int latelyFollower;//最近的追书者
    private double retentionRatio;//留存的比例

    private String category;//分类
    private String bookCovers;//书籍封面
    private int readedCount;//已读
    private int readingCount;//在读
    private int collectionCount;//收藏
    private int shelfStatus;//书籍状态,是否在书架上
    ...
    private int totalWordCount;//总字数


    //最新更新日期
    private String updated;//最近更新时间
    //最新阅读日期
    private String lastRead;//最新阅读时间
    private int chaptersCount;//章节数
    private String lastChapter;//最新章节

    private int isFinishFlag;//是否完结

    public int getIsFinishFlag() {
        return isFinishFlag;
    }

    public void setIsFinishFlag(int isFinishFlag) {
    ...
    @Generated(hash = 1697411216)
    public CollBookBean(String _id, String title, String author, String shortIntro, String cover, boolean hasCp,
            int latelyFollower, double retentionRatio, String category, String bookCovers, int readedCount,
            int readingCount, int collectionCount, int shelfStatus, String source, int totalWordCount,
            String updated, String lastRead, int chaptersCount, String lastChapter, int isFinishFlag,
