    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        ...
        builder.baseurl(Api.APP_DOMAIN)
                ...
                .okhttpConfiguration((context1, okhttpBuilder) -> {//这里可以自己自定义配置 Okhttp 的参数
                    ...
                    RetrofitUrlManager.getInstance().putDomain(Api.APP_DOMAIN_KEY_2, Api.APP_DOMAIN_2);
                    RetrofitUrlManager.getInstance().putDomain(Api.APP_DOMAIN_KEY_6, Api.APP_DOMAIN_6);
                })
