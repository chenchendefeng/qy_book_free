...
import com.wy.adbook.di.module.SignCalenderModule_ProvideLayoutManager1$application_releaseFactory;
import com.wy.adbook.di.module.SignCalenderModule_ProvideLayoutManager2$application_releaseFactory;
...
public final class DaggerSignCalenderComponent implements SignCalenderComponent {
  ...
  private Provider<LinearLayoutManager> provideLayoutManager1$application_releaseProvider;

  private Provider<FullyGridLayoutManager> provideLayoutManager2$application_releaseProvider;
  ...
  private void initialize(final Builder builder) {
    ...
    this.provideLayoutManager1$application_releaseProvider =
        DoubleCheck.provider(
            SignCalenderModule_ProvideLayoutManager1$application_releaseFactory.create(
                builder.signCalenderModule));
    this.provideLayoutManager2$application_releaseProvider =
        DoubleCheck.provider(
            SignCalenderModule_ProvideLayoutManager2$application_releaseFactory.create(
                builder.signCalenderModule));
  }
  ...
  private SignCalenderActivity injectSignCalenderActivity(SignCalenderActivity instance) {
    ...
    SignCalenderActivity_MembersInjector.injectMLayoutManager1(
        instance, provideLayoutManager1$application_releaseProvider.get());
    SignCalenderActivity_MembersInjector.injectMLayoutManager2(
        instance, provideLayoutManager2$application_releaseProvider.get());
