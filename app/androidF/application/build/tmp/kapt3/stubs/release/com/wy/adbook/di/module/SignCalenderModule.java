...
public final class SignCalenderModule {
    ...
    @dagger.Provides()
    @com.jess.arms.di.scope.ActivityScope()
    public final android.support.v7.widget.LinearLayoutManager provideLayoutManager1$application_release() {
        return null;
    }
    ...
    @dagger.Provides()
    @com.jess.arms.di.scope.ActivityScope()
    public final com.freebookqy.viewlib.rv.layoutmanager.FullyGridLayoutManager provideLayoutManager2$application_release() {
        return null;
    }
