 ...
 */
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    private boolean mForceShowLoadMoreViewInSizeZero = false;
    ...
    protected void autoUpFetch(int positions) {
    ...
    public int getLoadMoreViewCount() {
        ...
        if (mData.size() == 0 && !mForceShowLoadMoreViewInSizeZero) {
            return 0;
        }
        return 1;
    }
    ...
    /**
     * 在datalist size == 0的情况下也显示loadmoreview
     */
    public void setForceShowLoadMoreViewInSizeZero(boolean isShow) {
        mForceShowLoadMoreViewInSizeZero = isShow;
    }
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case LOADING_VIEW:
                ...
                break;
            case HEADER_VIEW:
                baseViewHolder = createViewHolder(mHeaderLayout);
                break;
            case EMPTY_VIEW:
                baseViewHolder = createViewHolder(mEmptyLayout);
                break;
            case FOOTER_VIEW:
                baseViewHolder = createViewHolder(mFooterLayout);
                break;
            default:
    ...
    protected BaseViewHolder getLoadingView(ViewGroup parent) {
        View view = getItemView(mLoadMoreView.getLayoutId(), parent);
        BaseViewHolder holder = getLoadMoreHolder(view);
    ...
    @NonNull
    protected BaseViewHolder getLoadMoreHolder(View view) {
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        ...
        switch (viewType) {
            case 0: {
                convert((K) holder, getItem(position - getHeaderLayoutCount()));
                break;
            }
            case LOADING_VIEW:
    ...
    /**
     * 创建用于非item列表的ViewHolder
     *
     * @param view
     * @return
     */
    private K createViewHolder(View view) {
    ...
    public void setEmptyView(View emptyView, ViewGroup.LayoutParams layoutParams) {
        boolean insert = false;
        if (mEmptyLayout == null) {
            mEmptyLayout = new FrameLayout(emptyView.getContext());
            final ViewGroup.LayoutParams lp = emptyView.getLayoutParams();
