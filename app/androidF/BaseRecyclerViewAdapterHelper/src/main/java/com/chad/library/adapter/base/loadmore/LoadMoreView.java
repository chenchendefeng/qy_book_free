    ...
    public void convert(BaseViewHolder holder) {
        switch (mLoadMoreStatus) {
            ...
            case STATUS_DEFAULT:
                ...
                visibleLoadFail(holder, false);
                visibleLoadEnd(holder, false);
                statusDefault(holder);
                break;
        }
    }

    public void statusDefault(BaseViewHolder holder) {

    }

    public void statusEnd(BaseViewHolder holder) {

    }

    public void statusFail(BaseViewHolder holder) {

    }

    public void statusLoading(BaseViewHolder holder) {
