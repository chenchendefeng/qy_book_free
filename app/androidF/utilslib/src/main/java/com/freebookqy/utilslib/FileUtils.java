...
public class FileUtils {
    ...
    //获取文件的编码格式
    public static Charset getCharsets(String fileName) {
        BufferedInputStream bis = null;
    ...
    public static String getCachePath() {
        if (isSdCardExist()) {
            File dir = Utils.INSTANCE.getApp()
                    .getExternalCacheDir();
            if (dir != null) {
    ...
    //获取文件的编码格式
    public static Charset getCharsetObj(String fileName) {
        BufferedInputStream bis = null;
        Charset charset = Charset.GBK;
        byte[] first3Bytes = new byte[3];
        try {
