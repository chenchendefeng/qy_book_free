...
class SpannableStringUtils private constructor() {
    ...
    class Builder constructor(@param:NonNull private var text: CharSequence?) {
         ...
         * @return [Builder]
         */
        fun setFontFamily(@Nullable fontFamily: String): Builder {
         ...
         * @return [Builder]
         */
        fun setAlign(@Nullable align: Layout.Alignment): Builder {
            this.align = align
            return this
        }
         ...
         * @return [Builder]
         */
        fun setBitmap(@NonNull bitmap: Bitmap): Builder {
            this.bitmap = bitmap
            imageIsBitmap = true
            return this
        }
         ...
         * @return [Builder]
         */
        fun setDrawable(@NonNull drawable: Drawable): Builder {
         ...
         * @return [Builder]
         */
        fun setUri(@NonNull uri: Uri): Builder {
            this.uri = uri
            imageIsUri = true
            return this
        }
         ...
         * @return [Builder]
         */
        fun setClickSpan(@NonNull clickSpan: ClickableSpan): Builder {
         ...
         * @return [Builder]
         */
        fun append(@NonNull text: CharSequence): Builder {
            setSpan()
            this.text = text
            return this
        }
        ...
        private fun setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(ImageSpan(context, bitmap), start, end, flag)
                    bitmap = null
                    imageIsBitmap = false
                    ...
                    mBuilder.setSpan(ImageSpan(context, uri), start, end, flag)
                    uri = null
                    imageIsUri = false
                } else {
                    mBuilder.setSpan(ImageSpan(context, resourceId), start, end, flag)
                    resourceId = 0
    ...
    companion object {
         ...
         * @return [Builder]
         */
        fun getBuilder(context: Context, @NonNull text: CharSequence): Builder {
            return Builder(text).setContext(context)
        }
    }
}