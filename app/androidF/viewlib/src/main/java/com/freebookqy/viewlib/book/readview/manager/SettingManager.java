...
import com.freebookqy.viewlib.book.bean.BookMark;
import com.freebookqy.viewlib.book.readview.ThemeManager;
import com.freebookqy.viewlib.book.utils.SharedPreferencesUtil;
...
public class SettingManager {
    ...
    public int getReadBrightness() {
        return (int) ScreenUtils.getScreenBrightness();
    }
