...
import com.freebookqy.viewlib.book.readview.manager.SettingManager;
import com.freebookqy.viewlib.book.utils.FileUtils;
import com.freebookqy.viewlib.book.utils.LogUtils;
...
public class PageFactory {
    ...
    public PageFactory(Context context, int width, int height, int fontSize, String bookId,
        ...
        mTitlePaint.setColor(ContextCompat.getColor(Utils.INSTANCE.getApp(), R.color.chapter_title_day));
