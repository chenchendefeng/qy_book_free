...
public class HttpUtils {
	 ...
	 * @return
	 */
    public static String postData(String url, String jsonString, String key, String certPath) {
		...
		try {
			httpClient = (CloseableHttpClient)initCert(key,certPath);
		} catch (Exception e) {
			e.printStackTrace();
		}
		HttpPost post = new HttpPost(url);
	 ...
	 * @throws Exception
	 */
	private static HttpClient initCert(String mchId, String certPath) throws Exception {
		// 证书密码，默认为商户ID
		String key = mchId;
		// 证书的路径
