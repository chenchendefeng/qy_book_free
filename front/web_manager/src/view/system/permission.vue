  ...
  <section>
    ...
    <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <el-table-column prop="img" label="头像" width="150">
        <template >
          <img :src="`static/img/img.jpg`" alt="" style="width: 50px;height: 50px; ">
        </template>
      </el-table-column>
      ...
      <el-table-column prop="loginName" label="登陆账户" width="150">
      </el-table-column>

      <el-table-column label="操作" align="right">
        <template slot-scope="scope">
          <el-button size="small" @click="handleEdit(scope.$index, scope.row)">修改</el-button>
          <el-button size="small" type="warning" @click="handleSettings(scope.$index, scope.row)">修改密码</el-button>
    ...
    <!--编辑界面-->
    <el-dialog title="详细信息" :visible.sync="editFormVisible" width="40%" v-loading="editLoading">
    ...
    <!--新增界面-->
    <el-dialog title="新增用户" :visible.sync="addFormVisible" width="30%">
    ...
    <!--权限界面-->
    <el-dialog title="权限" :visible.sync="qxFormVisible" width="30%">
      <el-form ref="qxForm" :model="addForm" label-width="100px" :rules="qxFormRules">
        <el-form-item label="选择角色" prop="usertype">
          <el-select v-model="qxForm.usertype" placeholder="用户" @change="currentSel">
            <el-option label="BOOS" value="1">
            </el-option>
        ...
        <el-form-item label="选择权限">
          <el-checkbox-group v-model="qxForm.checkedCities">
            <el-checkbox v-for="city in qxForm.cities" :label="city" :key="city">{{city}}</el-checkbox>
          </el-checkbox-group>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
