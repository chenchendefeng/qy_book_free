...
public class DateFormatUtil {
	...
	public static String FORMAT_LONG_FULL = "yyyyMMddHHmmss";
	...
	public static Long countSeconds(Date date1, Date date2) {
		...
		try {
			dateA = parse(date1, "yyyy-MM-dd HH:mm:ss");
			dateB = parse(date2, "yyyy-MM-dd HH:mm:ss");
		} catch (ParseException e) {
			return 0L;
		}
	...
	public static String getStartDate(Date date) {
		...
		String shortDate = format(date, FORMAT_SHORT);

		return shortDate + START_TIME;
	}
	...
	public static String getYesterdayShort() {
		Date date = getCurrentStartTime();
		Date yesterDay = subDay(date, 1);
		return parseDate(yesterDay,FORMAT_SHORT);
	}
	 ...
	 * @return
	 */
	public static Integer getMonthsDate(Date date) {
	...
	public static void main(String[] args) {
		Date now = new Date();
		Date date = addDay(now, 5);
		int i = compareDate(now, date, 0);


		Integer monthsDate = getMonthsDate(date);
	}

	public static String formatShort(Date now) {
		return format(now,FORMAT_SHORT);
	}

	public static String getFormatLongFull(Date date){
		return format(date,FORMAT_LONG_FULL);
	}
}
